...
namespace ServerLib
{
    ...
    public class GameConstants
    {
        ...
        public const GamePoint MATCHING_PHASE_1_POINT_BOUND = 100;
        public const GamePoint MATCHING_PHASE_2_POINT_BOUND = 200;
        public const GamePoint MATCHING_PHASE_3_POINT_BOUND = 500;
        public const GamePoint MATCHING_PHASE_4_POINT_BOUND = 1000;

        public static GamePoint GetPointBound_ByRegistTime(SecCnt elapsed)
        {
    ...
    public class MatchingNode
    {
        ...
        public void Init(PlayerId id, GamePoint point, SecCnt regTime)
        {
            Id = id;
            Point = point;
            RegTime = regTime;
